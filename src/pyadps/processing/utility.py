...
class QCCheckStats:
    ...
    threshold : float | list[float] | tuple[float, ...] | dict[str, float] | None
        ...
        - tuple: Min/max range or (kernel_size, cutoff) pair (e.g., despike, flatline)
        - dict[str, float]: Per-component thresholds (e.g., velocity cutoff U/V/W)
