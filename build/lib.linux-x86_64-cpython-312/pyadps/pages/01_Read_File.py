...
def file_read(path):
    """
    Reads the binary file and stores them into variables


    Args:
        path (string): Path of the binary file in the temporary folder

    Returns:
        head (object): Python object that stores file header details
        flead (object): Python object that stores Fixed Leader details
        vlead (object): Python object that stores Variable Leader details
        velocity (numpy array): Contains velocity array
        echo (numpy array): Contains echo intensity array
        correlation (numpy array): Contains correlation array
        pgood (numpy array): Contains percent good array
    """
    ds = rd.ReadFile(path, run="fortran")
    ...
    return head, flead, vlead, velocity, echo, correlation, pgood
...
if uploaded_file is not None:
    ...
    # Get data
    head, flead, vlead, velocity, echo, correlation, pgood = file_read(
