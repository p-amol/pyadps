...
class CutBins:
    """
    A class for manually adjusting and visualizing bins in ADCP data.

    This class provides a graphical user interface to interactively
    modify bin data in a 2D array using various tools such as sliders,
    ...
    def __init__(
        ...
        """
        Initializes the CutBins object.

        :param data: 2D numpy array of ADCP data.
        :param mask: 2D numpy array representing the mask (1 for masked).
        :param newmask: Boolean, whether to create a new mask.
        :param t1: Start index for the time dimension.
        :param t2: End index for the time dimension.
        :param tinc: Increment value for navigating through time.
        :param z1: Start index for the depth dimension.
        :param z2: End index for the depth dimension.
        :param zinc: Increment value for navigating through depth (not used).
        """
        # DATA SETUP
        self.orig_data = data
